...
tip2.place(x=280,y=30)
packageCnt = tk.Entry(window, show=None)
packageCnt.place(x=350, y=30)



b_1 = tk.Button(window, text='开始抓包', width=15, height=2,command=start).place(x=750, y=15)
b_4 = tk.Button(window, text='持续监听', width=15, height=2,command=model2).place(x= 1030,y=15)
...
t = tk.Text(window, wrap="none", height=80, width=200,foreground='green',yscrollcommand=yscrollbar.set, xscrollcommand=xscrollbar.set)
